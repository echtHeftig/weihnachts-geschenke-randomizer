...
@Component
public class PresentTableServiceImpl implements PresentTableService {

    private static final Logger LOGGER = LoggerFactory.getLogger(PresentTableServiceImpl.class);

    private PersonService personService;
    private ForbiddenListService forbiddenListService;

    public PresentTableServiceImpl(PersonService personService, ForbiddenListService forbiddenListService) {
        this.personService = personService;
        this.forbiddenListService = forbiddenListService;
    }

    private List<Person> getParticipants() {
